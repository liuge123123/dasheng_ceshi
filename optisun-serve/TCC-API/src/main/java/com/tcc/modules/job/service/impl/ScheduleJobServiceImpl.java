...
package com.tcc.modules.job.service.impl;
...
import com.tcc.modules.job.service.ScheduleJobService;
import com.tcc.modules.job.dao.ScheduleJobDao;
import com.tcc.modules.job.entity.ScheduleJobEntity;
import com.tcc.modules.job.utils.ScheduleUtils;
...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
	...
	public void delete(Long jobId) {
		ScheduleUtils.deleteScheduleJob(scheduler, jobId);
		//删除数据
		this.removeByIds(Arrays.asList(jobId));
