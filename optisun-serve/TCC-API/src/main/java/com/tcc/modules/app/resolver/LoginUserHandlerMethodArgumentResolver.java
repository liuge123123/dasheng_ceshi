...
package com.tcc.modules.app.resolver;
...
import com.tcc.modules.app.interceptor.AuthorizationInterceptor;
...
public class LoginUserHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer container,
        ...
        //获取用户信息
        UserEntity user = userService.getUserById((String)object);
        if(user.getStatus() != 1){
            throw new WTDPException(ResultCode.RESULT_100010);
        }
//        user.setPwd("");
        //user.setPwd1("");
        return user;
