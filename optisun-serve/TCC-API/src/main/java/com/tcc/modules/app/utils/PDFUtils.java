...
public class PDFUtils {
    ...
    public static void main(String[] args) throws IOException {
        String pdfFile = "D:\\下载.pdf";
        byte[] pdfData = getPDFData(pdfFile);
    ...
    public static byte[] getPDFData(String path) throws IOException {
    ...
    public static List<Object[]> getKeyWords(String filePath, final String keyWord) {
