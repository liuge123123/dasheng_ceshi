<template>
  <el-card v-loading="loading">
    <el-page-header class="cph" @back="goBack" content="云存储配置"></el-page-header>
    <el-form
      :model="dataForm"
      :rules="dataRule"
      ref="dataForm"
    ...
    >
      ...
      <template v-else-if="dataForm.type==4">
        <el-form-item label="本地域名">
          <el-input v-model="dataForm.localDomain" placeholder="本地域名"></el-input>
        </el-form-item>
        <el-form-item label="本地路径前缀">
          <el-input v-model="dataForm.localPrefix" placeholder="不设置默认为空"></el-input>
        </el-form-item>
        <el-form-item label="本地存储目录">
          <el-input v-model="dataForm.localDirName" placeholder="本地存储目录"></el-input>
        </el-form-item>
      </template>
