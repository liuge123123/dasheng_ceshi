<template>
  <div>
    <el-card class="mod-menu" v-if="!addOrUpdateVisible">
      <el-form :inline="true" :model="dataForm" size="mini">
        <el-form-item>
          <el-button size="small" icon="el-icon-plus"  v-if="isAuth('sys:menu:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        </el-form-item>
      </el-form>

      <el-table :data="dataList" row-key="menuId" size="small" style="width: 100%; " v-loading="dataListLoading">
