<template>
  <el-card v-loading="loading">
    <el-page-header class="cph" @back="goBack" :content="!dataForm.deptId ? '新增' : '修改'"></el-page-header>
    <el-form class="cpf" :model="dataForm" :rules="dataRule" ref="dataForm" label-width="120px" size="small">
    <el-form-item label="部门名称" prop="name">
      <el-input v-model="dataForm.name" placeholder="部门名称" maxlength="50"></el-input>
    </el-form-item>
    <el-form-item label="父节点" prop="parentId">
      ...
      <el-form-item label="排序" prop="sort">
        <el-input-number v-model="dataForm.sort" size="medium" controls-position="right" :min="1" :max="10000"
